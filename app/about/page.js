...
const page = () => {
	...
	return (
		<div>
			<div class="bg-white">
				<header class="bg-[#215585] text-white text-center py-12 flex items-center justify-center">
				...
				<section class="bg-[#215585] text-white py-12 px-4">
				...
				<section class="text-center py-12 px-4">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8">
						<div class="p-4 shadow-lg rounded-lg bg-[#4c81b3] hover:bg-[#699ac8] transition-colors">
				...
				<section class="bg-[#215585] text-white text-center py-12 px-4">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
						<div class="p-4 shadow-lg rounded-lg bg-[#153654] hover:bg-[#2a5d8c] transition-colors">
							<p>
				...
				<section className="py-14 lg:py-10">
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						...
						<div className="swiper teamswiper pb-10">
							...
							<div className="flex gap-4 justify-end items-center mr-8">
								<button
