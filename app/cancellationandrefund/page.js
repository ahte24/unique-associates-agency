	...
	return (
		<div class="bg-gray-100">
			<div class="container mx-auto px-4 py-8">
				<h1 class="text-3xl font-bold mb-4">Cancellation and Refund Policy</h1>

				<p class="mb-4">
					This Cancellation and Refund Policy outlines the rules and procedures
					regarding cancellations and refunds for purchases made through our
					website.
				</p>
				...
				<p class="mb-4">
					We reserve the right to modify or update this cancellation and refund
					policy at any time, so please review it frequently. Any changes will
					take effect immediately upon posting to this page.
				</p>
